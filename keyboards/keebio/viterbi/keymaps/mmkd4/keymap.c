...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	//-----------|---------|-----------|-----------|---------|----------|--------------|	|---------|----------|----------|---------|---------|---------|---------|
	    KC_TAB   , KC_QUOT , KC_COMM   , KC_DOT    , KC_P    , KC_Y     , MO(3)        ,	  KC_F    , KC_G     , KC_C     , KC_R    , KC_L    , KC_L_BRK, KC_TD_SLSH ,
	//-----------|---------|-----------|-----------|---------|----------|--------------|	|---------|----------|----------|---------|---------|---------|---------|
	    KC_ESC   , KC_A    , KC_O      , KC_E      , KC_U    , KC_I     , LALT(KC_GRV) ,	  KC_D    , KC_H     , KC_T     , KC_N    , KC_S    , KC_MINS , KC_ENT  ,
	//-----------|---------|-----------|-----------|---------|----------|--------------|	|---------|----------|----------|---------|---------|---------|---------|
	    KC_LSFT  , KC_SCLN , KC_Q      , KC_J      , KC_K    , KC_X     , MO(2)				 ,	  KC_B    , KC_M     , KC_W     , KC_V    , KC_Z    , KC_UP   , MO(3)   ,
	//-----------|---------|-----------|-----------|---------|----------|--------------|	|---------|----------|----------|---------|---------|---------|---------|
